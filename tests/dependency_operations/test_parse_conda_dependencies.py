...
#         parsed_yaml_mock = mocker.patch(
#             "yaml.safe_load.return_value.read_text")
...
#
#         return_value = parse_dependencies_file(fake_file, platform=platform)
#
#         assert return_value == {
#             "dependencies": [
...
#                 Dependency(name="pydantic", version="1.8.2",
#                            platform=platform),
#             ],
#             # "tools": [],
#         }
